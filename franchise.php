				...
				<div class="col-lg-9 col-md-9 col-sm-12">
					...
					<ul class="list-group">
						...
						<li class="list-group-item">Extra Revenue from Training Program based on Forex and Stock
							Markets.</li>
						<li class="list-group-item">Exclusive business right for the Area.</li>
						<li class="list-group-item"> Extra 15% revenue from Data-feed charges</li>
					</ul>
