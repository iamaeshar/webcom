...
<body>
    ...
    <section id="banner-sec" class="shadow-sm">
        <img src="images/banners/trade-goldmine-robo.jpg" alt="webcome banner" class="img-fluid">
    </section>
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-lg-9 col-md-9 col-sm-12">
                    ...
                    <a href="http://www.webcomtechnologiesusa.com/payment.php" class="btn btn-primary" target="_blank">Buy Online <i class="fas fa-shopping-cart"></i></a>
                </div>
            </div>
        </div>
    </section>
